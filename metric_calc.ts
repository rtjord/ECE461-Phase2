 ...
 */
function extractMetricData(jsonPacket: string): MetricData[] 
{
    const metricData: MetricData[] = []; //Stores extracted metric data
...
function calculateCorrectness(data: any): number 
{
...
function calculateBusFactor(data: any): number 
{
...
function calculateRampup(data: any): number 
{
...
function calculateResponsiveness(data: any): number 
{
...
function checkLicenseExistence(data: any): number 
{
...
function calculateNetScore(correctness: number, busFactor: number, rampup: number, responsiveness: number, licenseExistence: number): number 
{
